...
import { IReactToggleProperty, ReactToggleButtonStoreType } from "model/control/Toggle";
import { TianyuElement } from "components/TianyuElement";

export class ReactToggle extends TianyuElement<IReactToggleProperty, IReactState> {
    ...
    public constructor(props: IReactToggleProperty) {
        super(ReactToggleButtonStoreType, props);
    ...
    protected onStateChange(_state: boolean): void {}
}
