...
} from "model/navigation/Navigation";
...
export class ReactNavigation extends TianyuElement<IReactNavigationProps, IReactState> {
    ...
    public override render(): React.ReactNode {
        ...
        this.inNarrowMode = (!this.isLoading && this.isNarrow()) || this.inNarrowMode;
     ...
     */
    protected renderForMobile(): React.ReactNode {
        return <div></div>;
    }
     ...
     * @returns {React.ReactNode} return react node
     */
    protected renderForNormal(): React.ReactNode {
        return <div></div>;
    }
     ...
     * @returns {React.ReactNode} return react node
     */
    protected renderForNarrow(): React.ReactNode {
        return <div></div>;
    }
