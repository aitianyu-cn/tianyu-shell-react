...
export class ReactHorizontalNavigation extends ReactNavigation {
    ...
    protected override renderForMobile(): React.ReactNode {
    ...
    private renderSelectedItemsForMobile(): React.ReactNode {
    ...
    protected override renderForNormal(): React.ReactNode {
        const normalItems: ReactNavigationItem[] = [];
        const assistItems: ReactNavigationItem[] = [];
        this.navigationItemsClassification({ normalItems: normalItems, assistItems: assistItems });
    ...
    private renderNormalItemsForNormalMode(normalItems: ReactNavigationItem[]): React.ReactNode {
    ...
    private renderAssistItemsForNormalMode(assistItems: ReactNavigationItem[]): React.ReactNode {
        const renderedItems: React.ReactNode[] = [];
    ...
    protected override renderForNarrow(): React.ReactNode {
        const normalItems: ReactNavigationItem[] = [];
        const assistItems: ReactNavigationItem[] = [];
        if (this.isMenuOpened) {
            this.navigationItemsClassification({ normalItems: normalItems, assistItems: assistItems });
    ...
    private renderSelectedItemsForNarrowMode(): React.ReactNode {
        const selectedItem = this.getSelectedItem();
